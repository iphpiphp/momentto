				...
				<div class="table-responsive" style="overflow: hidden; width: 100%; height: auto;">
					...
					?>
							<tr>
								...
								<td>
									<input type="text" name="tag_name" value="<?=$val['tag_name']?>" />
								</td>
								<td>
									<a href="javascript:;" class="btn btn-info modify">수정</a>
									<a href="javascript:;" class="btn btn-danger delete">삭제</a>
								</td>
							</tr>
							<? endforeach;  ?>
					</table>
					...
					<table class="table">
						...
						<tbody>
							<tr>
								...
								<td>
									<input type="tag_name" name="" />
								</td>
								<td><a href="javascript:;" class="btn btn-success insert">추가</a></td>
							</tr>
						</tbody>
					</table>
				</div>
