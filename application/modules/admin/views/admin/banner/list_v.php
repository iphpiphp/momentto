			...
			<div class="panel panel-primary plain toggle panelMove panelClose panelRefresh" id="jst_9">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="pie-charts">
                                        ...
                                        <div class="label"><a href="/admin/page/banner_company_analytics/?cid=<?=$val['cid']?>"><?=$val['name']?></a></div>
                                    </div>
									<? endforeach; ?>
                                </div>
                            </div>
				...
				<tbody>
						...
						?>
							<tr>
								...
								<!--td><?=$val['cnt']?></td -->
								<td><?echo anchor_popup('/admin/page/banner_detail/?memberId='.$val["memberId"].'&bannerId='.$val["bannerId"], ' 상세정보', $atts);?><!--a href="javascript:;" class="btn btn-info info" data-memberid="<?=$val['memberId']?>">상세정보</a --></td>
							</tr>
							<? endforeach;  ?>
					</tbody>
				</table>
