...
<div id="order" class="row side_page w1140">
	...
	<section>
		<h2 class="h2 color_red mtit">주문하신 무비</span><span>주문번호 : <?=$order['id']?></h2>
	...
	<section>
		...
		<dl class="row">
			...
			<dd class="col-sm-9 col-xs-8 name"><?=$order['memberName']?><span>(고객님께서는 <em><?=$order['memberId']?></em>으로 주문해 주셨습니다) </span></dd>
			<dt class="col-sm-3 col-xs-4">이메일</dt>
			<dd class="col-sm-9 col-xs-8"><?=$order['memberEmail']?></dd>
		</dl>
	</section>
	<section>
		...
		<dl class="row">
			...
			<dd class="col-sm-9 col-xs-8"><?=$order['useSavedMoney']?></dd>
			<dt class="col-sm-3 col-xs-4">최종결제금액</dt>
			<dd class="col-sm-9 col-xs-8"><?=$order['price']?></dd>
		</dl>
	</section>
	<!-- section>
