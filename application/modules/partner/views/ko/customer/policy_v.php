...
<div class="container">
	<section class="info-policy-content rounding">
		<header class="info-header">
				<h2>이용약관</h2>
				<p class="txt-guide">
					더데이즈는 정보통신망법의 개인정보취급방침을 준수하고 있습니다.<br> 
					더데이즈에 가입하려면 이용약관 및 개인정보 제공 및 활용동의서에 동의하셔야 합니다.
				</p>
			</header>
<p class=""><div class="bs-callout bs-callout-info fade in txt-pre">제1장 총칙

제1조 (목적)
본 약관은 주식회사 위드비디오 (이하 '회사'라 합니다)가 운영하는 인터넷사이트[http://www.thedays.co.kr(이하 '위드비디오 웹사이트'라 합니다)를 통하여 회사가 제공하는 전자지급결제대행서비스, 선불전자지급수단의 발행 및 관리 서비스(이하 통칭하여 “전자금융거래 서비스’라 합니다)를 이용자가 이용하는 경우, 회사와 이용자 간 전자금융거래의 법률관계를 정함에 그 목적이 있습니다.
...
부칙
제1조 (적용일자) 
		이 약관은 2013년 12월 31일부터 시행됩니다.</div></p>
			</section>
</div>
