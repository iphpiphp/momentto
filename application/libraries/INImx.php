...
require(APPPATH. "/libraries/HttpClientM.php");
     	...
     	if($httpclient->HttpRequest($this->m_serviceurl, $msg))
       	...
       	// 응답 전문 파싱
				...
				if($this->m_payMethod == "CARD"){
					...
					$this->m_cardIssuerCode = null;
					$this->m_cardNum  = null;
					$this->m_cardMembernum  = null;
					$this->m_cardpurchase  = null;
					$this->m_prtc  = null;
					$this->m_cardinterest  = null;
					$this->m_cardcheckflag  = null;
					$this->m_cardName  = null;              
					$this->m_cardSrcCode  = null;
				}
				
				
				
				//휴대폰
				if($this->m_payMethod == "MOBILE"){
					$this->m_codegw  = $resultString['P_HPP_CORP'];
					$this->m_hppapplnum  = $resultString['P_APPL_NUM'];  // 추가
					$this->m_hppnum  = $resultString['P_HPP_NUM'];  // 추가
				}else{
					$this->m_codegw  = null;
					$this->m_hppapplnum  = null;
					$this->m_hppnum  = null;
				}
