...
<section id="sect2" class="row pb20">
		...
		<ul class="category_tab clearfix">
			...
			<li><a  href="#" <?=(!$this->input->get('cate_id',true))? 'class="on"':'' ?> item="all" id="cate_head">ALL</a></li>
			<li><a href="#" item="1" <?=($this->input->get('cate_id',true) == 1)? 'class="on"':'' ?>>BABY&amp;KIDS</a></li>
			<li><a href="#" item="2" <?=($this->input->get('cate_id',true) == 2)? 'class="on"':'' ?>>LOVE</a></li>
			<li><a href="#" item="3" <?=($this->input->get('cate_id',true) == 3)? 'class="on"':'' ?>>WEDDING</a></li>
			<li><a href="#" item="4" <?=($this->input->get('cate_id',true) == 4)? 'class="on"':'' ?>>BIRTHDAY</a></li>
			<li><a href="#" item="5" <?=($this->input->get('cate_id',true) == 5)? 'class="on"':'' ?>>TRAVEL</a></li>						
			<li><a href="#" item="6" <?=($this->input->get('cate_id',true) == 6)? 'class="on"':'' ?>>D-CARD</a></li>		
		</ul>
