...
<div id="container" class="clearfix">
	<div class="pa10 bg_wh">
		...
		<div class="tabs mb20">
			...
			<pre style="    white-space: pre-line; padding-top:0px;">
		<div id="myTabContent2" class="tab-content">
			<div class="tab-pane fade active in" id="home1">개인정보의 보유 및 이용기간
...
나. 기타, 이용자의 개별적인 동의가 있는 경우에는 개별 동의에 따른 기간까지 보관합니다
			...
			<div class="tab-pane fade" id="profile1">개인정보의 수집 및 이용목적
...
<div class="tab-pane fade" id="settings1">수집하는 개인정보 항목
...
- 상품구매 : 성명, 휴대전화번호, 연락처, 신용카드번호, 계좌번호 , 거래은행명
- 환불 : 계좌번호, 거래은행명, 계좌
...
나. 개인정보 수집 방법 
- 홈페이지(회원가입, 고객센터게시판, 협력/제휴) 및 고객센터를 통한 전화 및 온라인 상담 - 구독하기 페이지 및 이벤트 페이지를 통한 입력
			</div>
		</pre>
		</div>
	</div>
