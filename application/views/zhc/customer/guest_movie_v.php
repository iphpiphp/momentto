					...
					<div style="min-height:603px">
						...
						<div class="cnt_wrp">
							...
							<div class="btnarea">
								...
								<!-- 진행 중 -->
								<?if($status_div == 'progress'){?>
									<div><a class="btn btn-lg btn-block move_start" href="#" data-itemid="<?=$val['item_id']?>" data-orderid="<?=$val['orderId']?>">무비메이커 진행하기</a></div>
									<p class="pt10 text-center"><a class="color_grey pull-left" href="/customer/emailaq_view/"><u>무비 Q&amp;A 질문하기</u></a></p>
								<? } ?>
								...
								<p class="pt10 clearfix">
									...
									<a class="color_blue pull-right" href="/review/write/<?=$val['pid']?>"><u>평점/리뷰 작성하기</u></a>
								</p>
								<? } ?>
