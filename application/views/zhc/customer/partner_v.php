...
<div id="cooperation" class="row side_page w1140">
	...
	<div class="form_bx row">
		...
		<form class="form-horizontal" action="/customer/partner_post/" method="post" id="form_post" enctype="multipart/form-data">
			...
			<div class="form-group mb10">
				<label for="company" class="col-xs-2 control-label">회사(단체명)</label>
				<div class="col-xs-10">
			...
			<div class="form-inline form-group mb10">
				...
				<div class="col-xs-10 input_wid">
					<input type="text" class="form-control" id="email" 			name="mail_id">
					 @ <input type="text" class="form-control" title="도메인주소" 	name="mail_domain">
			...
			<div class="form-group mb10">
				<div class="agree_txt">
					...
					<label class="pt10">
						<input type="checkbox" checked="checked"> 위의 개인정보 제공에 동의합니다.
					</label>
				</div>
			</div>
			<div class="mb10">
				<button type="submit" class="btn btn-lg btn-block bg_red2">문의/제안 신청</button>
			</div>
		</form>
	</div>
</div>
